...
/// Light Color Palette
const QUI_LIGHT_PRIMARY = ColorRange(
  s0: Color(0xFF040518),
  s10: Color(0xFF090A2F),
  s20: Color(0xFF0D0F47),
  s30: Color(0xFF11145E),
  s40: Color(0xFF1A1D8E),
  s50: Color(0xFF2227BD),
  s60: Color(0xFF2B31EC),
  s70: Color(0xFF3355FF),
  s80: Color(0xFF5B8FFF),
  s90: Color(0xFF8AB5FF),
  s95: Color(0xFFBAD4FF),
  s99: Color(0xFFD8E2FA),
  s100: Color(0xFFF2F6FA),
);

const QUI_LIGHT_GRAY_SCALE = ColorRange(
  s0: Color(0xFF1B1D20),
  s10: Color(0xFF3D3F45),
  s20: Color(0xFF525559),
  s30: Color(0xFF686A6E),
  s40: Color(0xFF7D7F83),
  s50: Color(0xFF939597),
  s60: Color(0xFFA9AAAC),
  s70: Color(0xFFBEBFC1),
  s80: Color(0xFFD4D4D6),
  s90: Color(0xFFE9EAEA),
  s95: Color(0xFFF4F4F5),
  s99: Color(0xFFF9F9F9),
  s100: Color(0xFFFDFDFD),
);
...
/// Dark Color Palette
const QUI_DARK_PRIMARY = ColorRange(
  s0: Color(0xFFF2F6FA),
  s10: Color(0xFFD8E2FA),
  s20: Color(0xFFBAD4FF),
  s30: Color(0xFF8AB5FF),
  s40: Color(0xFF5B8FFF),
  s50: Color(0xFF3355FF),
  s60: Color(0xFF2B31EC),
  s70: Color(0xFF2227BD),
  s80: Color(0xFF1A1D8E),
  s90: Color(0xFF11145E),
  s95: Color(0xFF0D0F47),
  s99: Color(0xFF090A2F),
  s100: Color(0xFF040518),
);

const QUI_DARK_GRAY_SCALE = ColorRange(
  s0: Color(0xFFFDFDFD),
  s10: Color(0xFFF9F9F9),
  s20: Color(0xFFF4F4F5),
  s30: Color(0xFFE9EAEA),
  s40: Color(0xFFD4D4D6),
  s50: Color(0xFFBEBFC1),
  s60: Color(0xFFA9AAAC),
  s70: Color(0xFF939597),
  s80: Color(0xFF7D7F83),
  s90: Color(0xFF686A6E),
  s95: Color(0xFF525559),
  s99: Color(0xFF3D3F45),
  s100: Color(0xFF1B1D20),
);
